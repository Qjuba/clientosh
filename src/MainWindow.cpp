...
void MainWindow::applyTheme()
{
    ...
    const QString qss = fill(QStringLiteral(
        ...
        "  background: {{tableBg}};"
        "}"
        "QTableWidget#dashTable::item, QTreeWidget#dashTable::item { padding: 8px 8px; font-size: 14px; }"
        "QTableWidget#dashTable::item:selected, QTreeWidget#dashTable::item:selected { background: {{selectedBg}}; color: {{textBright}}; }"
        "QTableWidget#dashTable::item:hover, QTreeWidget#dashTable::item:hover { background: {{hoverBg}}; }"
        "QTreeWidget#dashTable { font-size: 14px; }"
